...
export default function FeatureText({ data }: FeaturedTextProps) {
  ...
  return (
    <section>
      <div className="container flex mx-auto sm:py-8 lg:py-20 justify-center">
        <div className="p-6 text-center lg:w-3/4 xl:w-2/3">
          ...
          <p className="mb-8 text-2xl md:text-3xl lg:text-4xl sm:mb-12 text-ellipsis overflow-hidden md:leading-loose leading-relaxed">
            {text}
          </p>
        </div>
      </div>
