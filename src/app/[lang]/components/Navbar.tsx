    ...
    <div className={`p-4`}>
      <div className="container flex justify-between h-16 mx-auto px-0 sm:px-6">
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 rtl:left-0 ltr:right-0 z-50 w-full overflow-y-auto dark:bg-black bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
              ...
              <div className="-my-6 divide-y divide-black dark:divide-white">
                ...
                {links.map((item) => (
                  ...
                  ))}
                  {
                    theme === 'dark' ? 
                    (
                      <li onClick={() => setTheme('light')} className="cursor-pointer flex py-4">
                        <MdOutlineLightMode style={{fontSize: '1.5em'}}/>
                      </li>
                    )
                    :
                    (
                      <li onClick={() => setTheme('dark')} className="cursor-pointer flex py-4">
                        <MdOutlineLightMode style={{fontSize: '1.5em'}}/>
                      </li>
                  )}
                </div>
