...
export const ReactBtcPayButton = ({
  ...
  // REQUIRED Props
  btcPayDomain = btcpayUrl, // Required
  storeId = btcpayStoreId, // Required
  ...
  return (
    ...
    >
      ...
      <div style={outerContainerStyles}>
        ...
        >
          {currencyOptions.map((curr) => (
            <option key={curr} value={curr} style={selectOptionStyles}>
              {curr}
            </option>
          ))}
        </select>
      ...
      >
        <span style={submitButtonTextStyles}>{submitBtnText}</span>
        {imageShow && (
          <img
            src={`https://${stripHttpHttps(
              btcPayDomain
            )}/img/paybutton/logo.svg`}
            alt="BTCPay Logo"
            style={imageStyles}
          />
        )}
